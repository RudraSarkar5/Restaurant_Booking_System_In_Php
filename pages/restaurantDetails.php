      ...
      <p class="text-gray-600">Timing: <?=$openingTime?> to <?=$closingTime?> </p>
        ...
        <div class="md:w-1/2 lg:w-1/2 w-full pt-5">
            <div class="big-photo-container" style="height: 400px; overflow: hidden;">
                <img id="bigPhoto" src="../resourses/restaurantImages/<?=$images[0]?>" alt=<?=$images[0]?> class="w-full h-full">
                  ...
                  <tbody>
                    ...
                    if(count($tableList) > 0 ){
                      ...
                      ?>
                        ...
                        <a
                          href="./bookingPage.php?restaurantId=<?=$restaurantId?>&tableId=<?=$tableList[$i]['id']?>"
