        ...
        <div class="bg-white bg-opacity-60 p-8 rounded-lg shadow-lg">
            ...
            <form action="./booking.php" method="POST" class="space-y-4">
                ...
                <div class='flex gap-2 justify-center items-center'>
                    ...
                    <input type="time" name="checkingTime" id="checkingTime" class="mt-1 p-2 rounded border w-full"
                        placeholder="checking time">
                </div>
                <div class='flex gap-2 justify-center items-center'>
                    <label for="checkoutTime" class="block text-sm font-bold text-black">Check-Out-Time</label>
                    <input type="time" name="checkoutTime" id="checkoutTime" class="mt-1 p-2 rounded border w-full"
