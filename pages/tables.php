      ...
      <div class="flex flex-col md:flex-row lg:flex-row w-screen h-screen">
        ...
        <div class="md:w-3/4 lg:w-3/4 w-full" id="content">
          ...
          <div class="flex flex-col mt-10">
                ...
                <table class="mt-4 border-collapse  table-auto border-black">
                  <thead>
                    <tr>
                      ...
                      <th class="lg:p-8 md:8 p-2 border">Seating-Capacity</th>
                      <th class="lg:p-8 md:8 p-2 border">Booking-Price Per Hour</th>
                      <th class="lg:p-8 md:8 p-2 border">Booking-Status</th>
                  ...
                  <tbody>
                    ...
                    <tr>
                      <td class="lg:p-8 md:8 p-2 border"><?=$tableList[$i]['seatingCapacity']?></td>
                      <td class="lg:p-8 md:8 p-2 border">₹ <?=$tableList[$i]['bookingPrice']?></td>
                      <?php
                        if($tableList[$i]['bookingStatus'] == 1){
                            echo "<td class='lg:p-8 text-green-500 md:8 p-2 border'>Booked</td>";
                        }else{
                            echo "<td class='lg:p-8 text-blue-500 md:8 p-2 border'>Available</td>";
                      ?>
                            <td class="lg:p-8 md:8 p-2 border flex gap-3">
                        <a
                          href="tables.php?restaurantId=<?=$restaurantId?>&tableId=<?=$tableList[$i]['id']?>"
                        ...
                        <a
                          href="../controler/tableDeleteForRestaurant.php?restaurantId=<?=$restaurantId?>&tableId=<?=$tableList[$i]['id']?>"
                          class="bg-blue-500 m-2 hover:bg-blue-700 text-white font-bold py-1 px-3 rounded"
                          >Delete</a
                        >
                      </td>
            ...
            <form
              action="../controler/tableAddForRestaurant.php"
              id="addMenuform"
              method="POST"
            ...
            >
              ...
              <div class="flex gap-5 justify-center items-center">
                <label for="tableCapacity" class="w-1/4 text-sm font-bold text-black"
              ...
              <div class="flex gap-8 justify-center items-center">
                <label
                  for="bookingPrice"
                  class="w-1/4 text-sm font-bold text-black"
                  >Booking Price</label
                >
                <input
                  type="Number"
              ...
              ?>
                    <form
              action="../controler/tableUpdateForRestaurant.php"
              id="editMenu"
              method="POST"
              class="space-y-4  "
            ...
            >
              ...
              <div class="flex gap-5 justify-center items-center">
                ...
                <input
                  ...
                  name="tableCapacity"
                  id="tableCapacity"
                  value=<?=$tableDetails['seatingCapacity']?>
                  class="mt-1 p-2 rounded border"
                  placeholder="Table Capacity"
                />
                <input
              ...
              <div class="flex gap-8 justify-center items-center">
                ...
                <input
                  ...
                  name="bookingPrice"
                  id="bookingPrice"
                  value=<?=$tableDetails['bookingPrice']?>
                  class="mt-1 p-2 rounded border"
                  placeholder="Booking Price"
                />
              </div>
